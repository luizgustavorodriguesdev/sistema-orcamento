...
const onMediaSelect = (media) => {
    // Insere o link de imagem selecionada no conteúdo HTML dependendo da aba ativa
    ...
    if (activeTab.value === 'html') {
        ...
        // Para o editor visual, se eles quiserem usar, inserimos no HTML cru. 
        // Como o editor se atualiza reativamente com v-model, podemos injetar no content diretamente.
...
<template>
    <Head title="Criar Página Institucional" />

    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Criar Página Institucional</h2>
        </template>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        ...
                        <div class="flex justify-between items-center mb-6">
                            <h3 class="text-xl font-bold">Nova Página</h3>
                        ...
                        <form @submit.prevent="submit" class="space-y-6 max-w-5xl">
                            ...
                            <!-- Slug -->
                            <div>
                                <label for="slug" class="block text-sm font-medium text-gray-700">Slug (URL SEO) - Opcional</label>
                                <input 
                                    v-model="form.slug" 
                                    type="text" 
                                    id="slug" 
                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" 
                                    placeholder="Ex: quem-somos (Deixe vazio para gerar automaticamente)"
                                />
